...
Please do not report vulnerabilities and security incidents as GitHub issues. Please contact us by sending an E-Mail to ospo@gematik.de or report them using the contact form at https://fachportal.gematik.de/kontaktformular.
...
We check our code with several tools including SonarQube and OWASP Dependency Check. We will inform you if there are any issues with your code.
