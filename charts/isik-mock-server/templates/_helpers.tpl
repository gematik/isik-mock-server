...
{{- define "hapi-fhir-jpaserver.fullversionname" -}}
...
app: {{ include "hapi-fhir-jpaserver.name" . }}
version: {{ .Chart.AppVersion | quote }}
...
Deployment labels
*/}}
{{- define "hapi-fhir-jpaserver.deploymentLabels" -}}
...
{{- default (include "hapi-fhir-jpaserver.fullversionname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "hapi-fhir-jpaserver.secretMountPath" -}}
{{- print "/secrets" }}
{{- end }}
